  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-4">
        <h3 className={`text-2xl font-bold transition-colors ${isExpanded ? 'text-accent' : 'text-primary group-hover:text-accent'}`}>
          {title}
        </h3>
        <svg
      ...
      <div className={`grid transition-all duration-500 ease-in-out ${
        ...
        <div className="overflow-hidden">
          <div className="border-t border-surface pt-6 space-y-6">
            ...
            <div>
              <h4 className="text-sm font-bold text-primary uppercase tracking-wider mb-2">3. Tech Stack</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-primary uppercase tracking-wider mb-2">4. Project Link</h4>
              <a 
                href={link}
                target="_blank"
